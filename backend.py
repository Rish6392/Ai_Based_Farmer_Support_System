...
<<<<<<< HEAD
                ...
                return {"answer": "Could not understand audio. Please speak clearly and try again."}
            except sr.RequestError as e:
                if temp_audio_path:
                    os.remove(temp_audio_path)
                return {"answer": f"Could not request results from Google Speech Recognition service: {str(e)}"}
            except Exception as e:
                if temp_audio_path:
                    os.remove(temp_audio_path)
